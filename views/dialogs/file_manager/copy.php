...
use Concrete\Package\FileManager\Controller\Dialog\FileManager\Copy;
...
<form method="post" data-dialog-form="file-manager-copy" action="<?php echo $controller->action('copy') ?>">
