...
use Concrete\Package\FileSystemManager\Controller\Dialog\FileSystemManager\Move;
...
<form method="post" data-dialog-form="file-system-manager-move" action="<?php echo $controller->action('move') ?>">
